...
export const confirmModalText = document.getElementById('confirm-modal-text') as HTMLElement;
export const confirmModalYesBtn = document.getElementById('confirm-modal-yes-btn') as HTMLButtonElement;
export const confirmModalNoBtn = document.getElementById('confirm-modal-no-btn') as HTMLButtonElement;
export const debugLogBtn = document.getElementById('debug-log-btn') as HTMLButtonElement;
export const debuggerPanel = document.getElementById('debugger-panel') as HTMLElement;
export const debugInput = document.getElementById('debug-input') as HTMLElement;
export const debugOutput = document.getElementById('debug-output') as HTMLElement;