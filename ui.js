...
import { getAbilityModifierValue } from './rpg-helpers.js';
...
function updateAbilityScores(playerState) {
    const getAbilityModifierString = (score) => { const mod = getAbilityModifierValue(score); return mod >= 0 ? `+${mod}` : String(mod); };
