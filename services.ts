...
import { SpeechRecognition, SpeechRecognitionEvent, SpeechRecognitionErrorEvent, ProviderSettings } from './types';
...
class TtsService {
    ...
    init(initialState: boolean, providerSettings: ProviderSettings) {
    ...
    disable(reason: 'key' | 'provider' = 'key') {
    ...
    private async getAudioFromAPI(text: string): Promise<HTMLAudioElement | null> {
...
class SpeechRecognitionService {
    ...
    init(onResult: (transcript: string) => void, onError: (error: string) => void) {
